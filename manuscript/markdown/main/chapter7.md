...
#### PowerShell Exploitation with Psmsf {#vps-identify-risks-powershell-exploitation-with-psmsf}
...
_Todo_: Screen record psmsf hack but make movie on another machine.
