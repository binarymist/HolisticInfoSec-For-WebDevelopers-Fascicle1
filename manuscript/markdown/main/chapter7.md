...
#### PowerShell Exploitation with [Psmsf](https://github.com/nixawk/psmsf) {#vps-identify-risks-powershell-exploitation-with-psmsf}
...
(`generate_powershell_script`) that embeds it into a PowerShell script that is going to become the main part of our payload.
...
_Todo_: Discuss the ones that didn't work and why they didn't, as part of this section. discuss what the name of the payload is, if we have a name, who wrote it, etc, it's history. Add any more relevant details from all the research browser tabs I have.



Check setoolkit (my version 7.4.3, current version 7.4.4).

_Todo_: Create another section at the same level of the [PowerShell Exploitation with Psmsf](#vps-identify-risks-powershell-exploitation-with-psmsf) heading, again covering exploitation, but for office docs and or pdfs.

_Todo_: Create another section at the same level of the [PowerShell Exploitation with Psmsf](#vps-identify-risks-powershell-exploitation-with-psmsf) heading, but for Maintaining persistence.

_Todo_: Create another section at the same level of the [PowerShell Exploitation with Psmsf](#vps-identify-risks-powershell-exploitation-with-psmsf) heading, but for Privesc, although this may be able to just be part of the Lateral movement section.

_Todo_: Create another section at the same level of the [PowerShell Exploitation with Psmsf](#vps-identify-risks-powershell-exploitation-with-psmsf) heading, but for Lateral movement.




_Todo_: Cleanup files on target win 7 desktop
